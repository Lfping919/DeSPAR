...
1. **下载模型权重：** 
   * **DeSPAR 核心权重：** [下载 weights.zip](https://github.com/你的用户名/DeSPAR/releases/download/v1.0.0/weights.zip)，下载完成后解压至项目根目录。
...
2. **下载数据集：** 请从 [百度网盘](链接) 获取 `ORSI-4199` 的核心图像数据（包含 Image, GT, Depth）。
