...
1. **Download Model Weights:**
   * **DeSPAR Core Weights:** [Download weights.zip](https://github.com/Lfping919/DeSPAR/archive/refs/tags/v1.0.0.zip), and extract it to the project root directory. *(Note: Replace with your actual release link after uploading)*
...
2. **Download Datasets:** Please get the core image data of `ORSI-4199` (including Image, GT, Depth) from [Link](https://pan.baidu.com/s/1HetiMuvt7D3Wdo4IuNu1ZQ?pwd=v7rm).
